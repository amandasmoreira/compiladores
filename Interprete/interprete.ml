...
(*Renomeei as ocorrências de 'infere_exp' para 'interpreta_exp' ALTERADA*)
...
(*Renomeei as ocorrencias de verifica_cmd para interpreta_cmd FALTA alterar*)
